...
public class SeleniumMain  {
	...
	public static void main(String[] args) {
		...
		//TODO:Long,Short,backupそれぞれ動作確認
		//TODO:引数によって動作するメソッドを変更する
		//TODO:Long,Short終わりにバックアップ実行

		//TODO：現行のLファイルをすべてDBに登録してみる

		//TODO:購入、売却メソッドの入力はBeanじゃなくてBeanのリストにする
		//TODO:LongとShortの共通部分を抜き出す
		//TODO:処理予定の株を持ってるかチェックをフィルターに
		//TODO;Firebugでチェク
		//TODO:売る際の端数計算で残る株数はそれ専用のentry,exitMethodを指定する
		//TODO:SetupをログインとIniの読み込み別に


		SeleniumMain selenium = new SeleniumMain();

		selenium.tradeSetup();
		selenium.tradeLong();
		//selenium.tradeShort();
		//selenium.newTradeShort();
		selenium.makeBackupFile();
